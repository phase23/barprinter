...
import com.szzcs.quickpayaipos.scan.ScanActivity;
...
public class sendtoCard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendto_card);
                ...
                "OK", "Cancel", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (etPwd.getText().toString().equals(getString(R.string.pwd_str))) {
                            final Dialog loading = DialogUtils.showProgress(sendtoCard.this, "Waiting", "Activate Barcode...");
                                ...
                                public void run() {
                                    ...
                                    if (sn == null) {
                                        runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(sendtoCard.this, "", Toast.LENGTH_SHORT).show();
                                                loading.dismiss();
                                            }
                                        });
                                        return;
                            ...
                            Toast.makeText(sendtoCard.this, getString(R.string.pwd_wrong), Toast.LENGTH_SHORT).show();
                        }
                    }
                }, null);
    ...
    private void activateBarcode(String id, final Dialog loading, String sn) {
        SDKUtils.getInstance(sendtoCard.this, id)
                .setDeviceId(sn)
                    ...
                    public void onActivateState(final boolean isActivated) {
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                loading.dismiss();
                                if (isActivated) {
                                    startActivity(new Intent(sendtoCard.this, ScanActivity.class));
                                } else {
                                    Toast.makeText(sendtoCard.this, "Activated failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
